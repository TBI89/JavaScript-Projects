...
// Load the existing products from storage and display on the page every time the page is refreshed:
...
function addProduct() {
    ...
    // Create an object for etch products entered by the user:
    ...
    // Save to new object to local storage:
    ...
    // Clear all boxes (after etch products the user adds):
